...
export const Landing = () => {
  ...
  return (
    <>
      ...
      <section id="problem" className="py-24 px-6 lg:px-20 bg-background">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
             <div className="space-y-4 mt-12">
                <div className="soft-card p-6 bg-background rotate-2 hover:rotate-0 transition-transform shadow-lg shadow-black/5">
                   <div className="w-10 h-10 bg-primary-soft/30 rounded-xl mb-4" />
                   <div className="h-2 w-20 bg-primary-soft/50 rounded-full mb-2" />
                   <div className="h-2 w-full bg-primary-soft/30 rounded-full" />
                </div>
                <div className="soft-card p-6 bg-background -rotate-3 hover:rotate-0 transition-transform shadow-lg shadow-black/5">
             ...
             <div className="space-y-4">
                <div className="soft-card p-6 bg-background -rotate-1 hover:rotate-0 transition-transform shadow-lg shadow-black/5">
                   <div className="w-10 h-10 bg-primary-soft rounded-xl mb-4" />
                   <div className="h-2 w-24 bg-primary-soft rounded-full mb-2" />
                   <div className="h-2 w-full bg-primary-soft/30 rounded-full" />
                </div>
                <div className="soft-card p-6 bg-background rotate-6 hover:rotate-0 transition-transform shadow-lg shadow-black/5 border-danger/20">
                ...
                <div className="overflow-hidden border border-border/80 rounded-3xl">
                  <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-border/20">
                      <tr className="hover:bg-primary-soft/10 transition-colors">
                        ...
                        <td className="px-8 py-6">
                          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-background border border-border rounded-full text-[10px] font-black uppercase tracking-tighter text-text-secondary">
                            <Clock size={12} /> 2j
                          </div>
                        </td>
                      </tr>
      ...
      <section id="features" className="px-6 lg:px-20 py-24 bg-primary-soft/10">
      ...
      <footer className="p-12 lg:p-20 flex flex-col items-center gap-8 bg-background">
        <div className="flex items-center gap-3">
          <motion.div 
